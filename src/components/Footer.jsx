    ...
    <div className=" relative w-screen h-screen   ">
      ...
      <div className="absolute font-['Matter'] backdrop-blur-3xl shadow-lg container w-full md:w-3/4 lg:w-1/2 h-[80%] md:h-[70%] lg:h-[60%] bg-[#141414]/70 top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 rounded-xl overflow-hidden">
        <div className="grid  grid-rows-12 h-full ">
          ...
          <div className=" col-span-2 px-5 border-b-[1px] text-lg  content-center border-zinc-100/30">
          ...
          <div className=" row-span-7 border-zinc-100/10 border-b-[1px]  col-span-2"> 
            <div className="w-full h-full px-5 py-3 text-lg">
              <textarea name="text" id="" style={{resize:"none",boxSizing:"border-box"}} className="w-full h-full bg-transparent focus:outline-none text-white/90 placeholder-zinc-100/20" placeholder="Say Something"></textarea>
            </div>
          </div>
          <div className="text-lg  col-span-2 px-5"> 
            <div className="w-full h-full flex justify-end items-center  ">
              <button className="w-[15%] h-[70%] bg-zinc-600 rounded-lg text-white/90">Send</button>
